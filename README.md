...
> ⚠️ A branch `main` está protegida — commits diretos são bloqueados. Só é possível enviar código via Pull Request.
...
As aulas e materiais complementares estão no Google Drive da disciplina.
O acesso deve ser solicitado com o mesmo e-mail da sua conta GitHub.
