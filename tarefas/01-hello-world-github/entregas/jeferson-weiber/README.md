...
| Domina | Aprendendo | Quero aprender |
|---|---|---|
| gestão de obra | Git e GitHub | Python |
|  |controle qualidade | Desenvolvimento web |
| acabamentos | Estudo e pesquisa | Inteligência artificial |

## Como me chamar

- Nome: Jeferson Weiber
- Curso: Engenharia civil

## Aviso importante

> “A disciplina e a persistência são fundamentais para transformar objetivos em conquistas.”
